...
async function connectToDatabase() {
  try {
    const uri = 'mongodb+srv://sheshadrimbsc22:uniquesheshadri@cluster0.4vsx93w.mongodb.net/see?retryWrites=true&w=majority'; // Replace with your MongoDB connection URI
